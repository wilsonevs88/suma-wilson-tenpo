...
public enum ResponseCode implements ExceptionInformation {
    ...
    AUTH_ERROR(9001, "AUTH ERROR", HttpStatus.OK),
    USER_BLOCKED(9002, "USER BLOCKED", HttpStatus.OK),
    MAXIMUM_QUERIES_PER_MINUTE(900, "MAXIMUM QUERIES PER MINUTE", HttpStatus.OK),
    ;
